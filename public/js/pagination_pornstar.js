document.addEventListener("DOMContentLoaded", () => {
    ...
    var Pagination = {
        ...
        Add: function (s, f) {
            for (var i = s; i < f; i++) {
                Pagination.code += '<a href="' + url + '/pornstar/' + search_query + '/page/' + i + '" rel="nofollow">' + i + '</a>';
            }
        },
        Last: function () {
            Pagination.code += '<i>...</i><a href="' + url + '/pornstar/' + search_query + '/page/' + Pagination.size + '" rel="nofollow">' + Pagination.size + '</a>';
        },
        First: function () {
            Pagination.code += '<a href="' + url + '/pornstar/' + search_query + '/page/1" rel="nofollow">1</a><i>...</i>';
        },
        Click: function () {
